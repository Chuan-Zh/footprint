...
if __name__ == "__main__":
    ...
    print("# %i connected components" % (nx.number_connected_components(G)))
    print("# %.3f transitivity" % (nx.transitivity(G)))


    print("reg\tLOO\tsize\tnodes\tedges\tratio\tavg_zscore\tconnected_comp\tlargest_comp_size\ttransitivity")
    ...
    for reg in regulon.keys():
        if len(regulon[reg]) > 2:
            ...
            if nx.number_of_nodes(H) < 2: continue
